...
{
    /*****************************************************
    * summary：继承抽象类，实现抽象方法。需添加System.Data.OracleClient.dll
    * date:2015-4-20
    * author:李捞扒
    ...
    ****************************************************/
    class Oracle : DataBase
    {
        ...
        /// 数据库连接串
        /// </summary>
        //private String ConnString = @"data source=oracle;user id=system;password=940918";
        private String ConnString = ConfigurationManager.ConnectionStrings["oracleconnstr"].ToString();
        /// <summary>
        /// 数据库连接
        /// </summary>
